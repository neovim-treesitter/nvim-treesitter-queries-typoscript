# nvim-treesitter-queries-typoscript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-typoscript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-typoscript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **typoscript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-typoscript",
...
- [ ] Changes are scoped to `typoscript` — do not include files for other languages
